...
if (a > b) console.log(a, b, "The bigger value is: ", a);
else console.log(a, b, "The bigger value is: ", b);
...
if (x > y && x > z) console.log(x, y, z, "The bigger number is:", x);
else if (y > x && y > z) console.log(x, y, z, "The bigger number is:", y);
else console.log(x, y, z, "The bigger number is:", z);
...
if (mystatus == true) {
  ...
  if (input % 2 == 0) console.log("Number is even");
