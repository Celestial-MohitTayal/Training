let customerlist = [
  {
    city: "Bangalore",
    account: ["Amir", "Shahrukh", "Salman", "Khan"],
  },
  {
    city: "Mumbai",
    account: ["Santosh", "Sunil", "Abhi"],
  },
  {
    city: "Chennai",
    account: ["Bhuvan", "Ali", "Aman", "Atul", "Suraj"],
  },
];
...
customerlist.map((customer, index) => {
  //loop1 #outer array
  console.log(index, customer.city);
...
customerlist.reverse().map((customer, index) => {
  //using reverse()
  console.log(index + 1, customer.city, "- (" + customer.account.length + ")");
